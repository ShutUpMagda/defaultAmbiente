...
class DefaultAmbienteChildThemePlugin extends ThemePlugin {
	/**
	...
	public function init() {
		...
		$this->addOption('accentColour', 'FieldColor', [
			'label' => __('plugins.themes.defaultAmbiente.option.accentColour.label'),
	...
	function getDisplayName() {
		return __('plugins.themes.defaultAmbiente.name');
	}
	...
	function getDescription() {
		return __('plugins.themes.defaultAmbiente.description');
	}
}
